        ...
        React.createElement("div", { className: "rounded-md bg-gray-50 p-4 md:p-6" },
            React.createElement("div", { className: "mb-4" },
                ...
                React.createElement("div", { className: "relative" },
                    React.createElement("select", { id: "customer", name: "customerId", className: "peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500", defaultValue: "" },
            ...
            React.createElement("div", { className: "mb-4" },
                ...
                React.createElement("div", { className: "relative mt-2 rounded-md" },
                    React.createElement("div", { className: "relative" },
                        React.createElement("input", { id: "amount", name: "amount", type: "number", step: "0.01", placeholder: "Enter USD amount", className: "peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500" }),
                ...
                React.createElement("div", { className: "rounded-md border border-gray-200 bg-white px-[14px] py-3" },
                    React.createElement("div", { className: "flex gap-4" },
                        React.createElement("div", { className: "flex items-center" },
                            React.createElement("input", { id: "pending", name: "status", type: "radio", value: "pending", className: "h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-gray-600" }),
                        ...
                        React.createElement("div", { className: "flex items-center" },
                            React.createElement("input", { id: "paid", name: "status", type: "radio", value: "paid", className: "h-4 w-4 border-gray-300 bg-gray-100 text-gray-600 focus:ring-2 focus:ring-gray-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-gray-600" }),
