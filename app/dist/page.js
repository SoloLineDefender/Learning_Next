    ...
    return (React.createElement("main", { className: "flex min-h-screen flex-col p-6" },
        ...
        React.createElement("div", { className: "mt-4 flex grow flex-col gap-4 md:flex-row" },
            ...
            React.createElement("div", { className: "flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12" },
                React.createElement(image_1["default"], { src: "/hero-desktop.png", width: 1000, height: 760, className: "hidden md:block", alt: "Screenshots of the dashboard project showing desktop and mobile versions" }),
                React.createElement(image_1["default"], { src: "/hero-mobile.png", width: 560, height: 620, className: "block md:hidden", alt: "Screenshots of the dashboard project showing desktop and mobile versions" })))));
}
